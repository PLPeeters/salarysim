...
export const taxationInfo: TaxationInfo = {
  ...
  isFinal: true,
  minimumSalary: [
    { effectiveFromMonth: 1, amount: D(2_154.11) },
    { effectiveFromMonth: 4, amount: D(2_189.81) },
    { effectiveFromMonth: 7, amount: D(2_233.61) },
  ],
      ...
      info: {
        employee: {
          partA: {
            ...
            flatAmount: D(125.04),
            multiplier: D(0.2738),
            amountToExclude: D(2_880.32),
          },
          partB: {
            maxSalary: D(2_880.32),
            flatAmount: D(168.62),
            multiplier: D(0.2699),
            amountToExclude: D(2_255.50),
          },
        },
        worker: {
          partA: {
