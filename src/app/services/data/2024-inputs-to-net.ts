...
const employeeWithHybridCar: SalaryCalculationInput = {
  ...
  companyCarInfo: {
    catalogValue: 32000,
    firstPlateRegistrationMonth: new Date(2021, 0, 21),
...
const employeeWithNaturalGasCar: SalaryCalculationInput = {
  ...
  companyCarInfo: {
    catalogValue: 50000,
    firstPlateRegistrationMonth: new Date(2023, 5, 1),
...
const employeeWithMoreRecentHybridCar: SalaryCalculationInput = {
  ...
  companyCarInfo: {
    ...
    firstPlateRegistrationMonth: new Date(2021, 5, 21),
  },
};
const employeeWithMoreRecentNaturalGasCar: SalaryCalculationInput = {
  ...
  companyCarInfo: {
    ...
    firstPlateRegistrationMonth: new Date(2024, 0, 1),
  },
};
...
export const INPUTS_TO_NET: Situation[] = [
  ...
  { input: { ...simpleEmployee, grossSalary: 2350 }, netSalary: 2026.43 },
  ...
  { input: { ...simpleWorker, grossSalary: 3050 }, netSalary: 2166.02 },
  { input: { ...simpleWorker, grossSalary: 3100 }, netSalary: 2178.08 },
  { input: { ...simpleWorker, grossSalary: 3150 }, netSalary: 2190.13 },
  ...
  { input: { ...simpleWorker, grossSalary: 3600 }, netSalary: 2373.53 },
  ...
  { input: { ...simpleWorker, grossSalary: 4500 }, netSalary: 2758.79 },
  ...
  { input: { ...marriedEmployeeOneIncome, grossSalary: 4029.16 }, netSalary: 3002.87 },
  ...
  { input: { ...marriedEmployeeWithDisabledPartner, grossSalary: 4029.16 }, netSalary: 3051.87 },
  ...
  { input: { ...marriedHalfTimeEmployeeOneIncome, grossSalary: 4029.16 }, netSalary: 3002.87 },
  ...
  { input: { ...marriedHalfTimeEmployeeTwoIncomes, grossSalary: 2328.33 }, netSalary: 1794.44 },
  ...
  { input: { ...widowedHalfTimeEmployeeWithOneKid, grossSalary: 2328.33 }, netSalary: 1896.55 },
  ...
  { input: { ...partTimeWorker, grossSalary: 2400 }, netSalary: 1888.47 },
  ...
  { input: { ...partTimeWorker, grossSalary: 4500 }, netSalary: 2758.79 },
