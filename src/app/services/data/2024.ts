...
export const taxationInfo: TaxationInfo = {
  ...
  isFinal: true,
  minimumSalary: [
    { effectiveFromMonth: 1, amount: D(1_994.18) },
    { effectiveFromMonth: 4, amount: D(2_029.88) },
    { effectiveFromMonth: 5, amount: D(2_070.48) },
  ],
  ...
  // https://finances.belgium.be/sites/default/files/downloads/121-faq-voitures-de-societe-2024.pdf
  ...
  referenceCO2Diesel: D(65),
  referenceCO2Other: D(78),
  minimumVehicleTaxedAmount: D(1_600),
};
