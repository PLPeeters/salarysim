...
export const INPUTS_TO_NET: Situation[] = [
  ...
  { input: { ...simpleEmployee, grossSalary: 2650 }, netSalary: 2103.43 },
  ...
  { input: { ...simpleWorker, grossSalary: 2100 }, netSalary: 1973.01 },
  { input: { ...simpleWorker, grossSalary: 2150 }, netSalary: 1996.98 },
  { input: { ...simpleWorker, grossSalary: 2200 }, netSalary: 2020.95 },
  ...
  { input: { ...simpleWorker, grossSalary: 2400 }, netSalary: 2055.65 },
  ...
  { input: { ...simpleWorker, grossSalary: 6100 }, netSalary: 3451.14 },
  ...
  { input: { ...marriedEmployeeTwoIncomes, grossSalary: 2328.33 }, netSalary: 2038.19 },
  ...
  { input: { ...divorcedEmployeeWithOneKid, grossSalary: 2328.33 }, netSalary: 2144.3 },
  ...
  { input: { ...widowedEmployeeWithOneKid, grossSalary: 2328.33 }, netSalary: 2144.3 },
  ...
  { input: { ...employeeWithOneKid, grossSalary: 2328.33 }, netSalary: 2144.3 },
  ...
  { input: { ...employeeWithOneDisabledKid, grossSalary: 2328.33 }, netSalary: 2227.3 },
  ...
  { input: { ...disabledEmployee, grossSalary: 2328.33 }, netSalary: 2093.3 },
  ...
  { input: { ...employeeWithGroupInsurance, grossSalary: 2328.33 }, netSalary: 2012.55 },
  ...
  { input: { ...employeeWithOtherNetIncome, grossSalary: 2328.33 }, netSalary: 2142.3 },
  ...
  { input: { ...disabledWorker, grossSalary: 2100 }, netSalary: 2024.01 },
  ...
  { input: { ...workerWithGroupInsurance, grossSalary: 2100 }, netSalary: 1943.26 },
  ...
  { input: { ...workerWithOtherNetIncome, grossSalary: 2100 }, netSalary: 2073.01 },
  ...
  { input: { ...marriedWorkerTwoIncomes, grossSalary: 2100 }, netSalary: 1968.9 },
  ...
  { input: { ...simpleEmployeeAnnual, monthlyIncomes: getMonthlyIncomes(2100) }, netSalary: 23862.96, netIncome: 26200.76 },
  { input: { ...simpleEmployeeAnnual, monthlyIncomes: getMonthlyIncomes(2328.33) }, netSalary: 24507.6, netIncome: 27017.55 },
  { input: { ...simpleEmployeeAnnual, monthlyIncomes: getMonthlyIncomes(2500) }, netSalary: 24899.04, netIncome: 27594.05 },
  { input: { ...simpleEmployeeAnnual, monthlyIncomes: getMonthlyIncomes(3000) }, netSalary: 26290.44, netIncome: 29206.83 },
  { input: { ...simpleEmployeeAnnual, monthlyIncomes: getMonthlyIncomes(4029.16) }, netSalary: 31275.12, netIncome: 34836.56 },
  { input: { ...simpleEmployeeAnnual, monthlyIncomes: getMonthlyIncomes(5000) }, netSalary: 36378.84, netIncome: 40444.2 },

  { input: { ...simpleWorkerAnnual, monthlyIncomes: getMonthlyIncomes(2100) }, netSalary: 23676.12, netIncome: 26013.92 },
  { input: { ...simpleWorkerAnnual, monthlyIncomes: getMonthlyIncomes(2328.33) }, netSalary: 24530.64, netIncome: 27040.59 },
  { input: { ...simpleWorkerAnnual, monthlyIncomes: getMonthlyIncomes(2500) }, netSalary: 24859.2, netIncome: 27554.21 },
  { input: { ...simpleWorkerAnnual, monthlyIncomes: getMonthlyIncomes(3000) }, netSalary: 26087.28, netIncome: 29003.67 },
  { input: { ...simpleWorkerAnnual, monthlyIncomes: getMonthlyIncomes(4029.16) }, netSalary: 30951.24, netIncome: 34512.68 },
  { input: { ...simpleWorkerAnnual, monthlyIncomes: getMonthlyIncomes(5000) }, netSalary: 36000.72, netIncome: 40066.08 },
]
